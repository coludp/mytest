...
//alert(7);
		...
		animate_slide: function (margin_left, complete, type)
		{
			...
			//alert($(this.$element.context).html());
			...
			if (Modernizr.csstransitions && type == 'css3') {
				...
				$(".vmcarousel").css("-webkit-transform", "translate3d(" + margin_left + "px,0px,0px)");
			
	alert($(".vmcarousel").css("transform"));
		...
		/**width: 1547px; transition: transform 0.5s; transform: translate3d(-221px, 0px, 0px);
		 * width: 2136px; transition: transform 0.5s; transform: translate3d(-266.5px, 0px, 0px);
		 * Resize event
		 */
		resize: function ()
		{
